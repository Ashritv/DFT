...
Module memlibc_memory_bist_assembly {
   ...
   Attribute icl_extraction_date = "Mon Apr 28 12:25:26 IST 2025";
   Attribute created_by_tessent_icl_extract = "true";
   Attribute tessent_design_id = "rtl";
   Attribute tessent_design_level = "sub_block";
   Instance mem_container_inst_m1_mem_inst Of SPRAM_4096x6 {
      InputPort A[11] = mem_container_inst_m1_mem_inst_interface_inst.A[11];
      InputPort A[10] = mem_container_inst_m1_mem_inst_interface_inst.A[10];
      InputPort A[9] = mem_container_inst_m1_mem_inst_interface_inst.A[9];
      InputPort A[8] = mem_container_inst_m1_mem_inst_interface_inst.A[8];
      InputPort A[7] = mem_container_inst_m1_mem_inst_interface_inst.A[7];
      InputPort A[6] = mem_container_inst_m1_mem_inst_interface_inst.A[6];
...
Module SPRAM_4096x6 {
   // ICL module read from source on or near line 17 of file '/home/01fe21bec241/DFT/Work/Creating_memLib/runs/runs2/tsdb_outdir/instruments/memlibc_memory_bist_assembly_rtl_mbist.instrument/SPRAM_4096x6.icl'
   DataInPort A[11:0] {
...
Module memlibc_memory_bist_assembly_rtl_tessent_mbist_c1_interface_m1 {
   // ICL module read from source on or near line 25 of file '/home/01fe21bec241/DFT/Work/Creating_memLib/runs/runs2/tsdb_outdir/instruments/memlibc_memory_bist_assembly_rtl_mbist.instrument/memlibc_memory_bist_assembly_rtl_tessent_mbist_c1_interface_m1.icl'
   ClockPort BIST_CLK;
...
Module memlibc_memory_bist_assembly_rtl_tessent_mbist_c1_controller {
   // ICL module read from source on or near line 26 of file '/home/01fe21bec241/DFT/Work/Creating_memLib/runs/runs2/tsdb_outdir/instruments/memlibc_memory_bist_assembly_rtl_mbist.instrument/memlibc_memory_bist_assembly_rtl_tessent_mbist_c1_controller.icl'
   ClockPort BIST_CLK;
   ...
   Alias A_ADD_REG_Y[5:0] = A_ADD_REG_Y_HW[5:0] {
   }
   Alias A_ADD_REG_X[5:0] = A_ADD_REG_X_HW[5:0] {
   }
   Alias B_ADD_REG_Y[5:0] = B_ADD_REG_Y_HW[5:0] {
   }
   Alias B_ADD_REG_X[5:0] = B_ADD_REG_X_HW[5:0] {
   }
   ...
   ScanRegister A_ADD_REG_Y_HW[0:5] {
      ScanInSource INST_POINTER_REG_HW[3];
   }
   ScanRegister A_ADD_REG_X_HW[0:5] {
      ScanInSource A_ADD_REG_Y_HW[5];
   }
   ScanRegister B_ADD_REG_Y_HW[0:5] {
      ScanInSource A_ADD_REG_X_HW[5];
   }
   ScanRegister B_ADD_REG_X_HW[0:5] {
      ScanInSource B_ADD_REG_Y_HW[5];
   }
   ScanRegister JCNT_HW[0:2] {
      ScanInSource B_ADD_REG_X_HW[5];
   }
...
Module memlibc_memory_bist_assembly_rtl_tessent_mbist_bap {
   // ICL module read from source on or near line 17 of file '/home/01fe21bec241/DFT/Work/Creating_memLib/runs/runs2/tsdb_outdir/instruments/memlibc_memory_bist_assembly_rtl_mbist.instrument/memlibc_memory_bist_assembly_rtl_tessent_mbist_bap.icl'
   ResetPort reset {
      ActivePolarity 0;
   }
...
Module memlibc_memory_bist_assembly_rtl_tessent_sib_2 {
   // ICL module read from source on or near line 17 of file '/home/01fe21bec241/DFT/Work/Creating_memLib/runs/runs2/tsdb_outdir/instruments/memlibc_memory_bist_assembly_rtl_ijtag.instrument/memlibc_memory_bist_assembly_rtl_tessent_sib_2.icl'
   ResetPort ijtag_reset {
      ActivePolarity 0;
   }
   SelectPort ijtag_sel;
...
Module memlibc_memory_bist_assembly_rtl_tessent_sib_1 {
   // ICL module read from source on or near line 17 of file '/home/01fe21bec241/DFT/Work/Creating_memLib/runs/runs2/tsdb_outdir/instruments/memlibc_memory_bist_assembly_rtl_ijtag.instrument/memlibc_memory_bist_assembly_rtl_tessent_sib_1.icl'
   ResetPort ijtag_reset {
      ActivePolarity 0;
   }
   SelectPort ijtag_sel;
