...
//          Version: 2022.4
//       Created on: Mon Apr 28 10:59:02 IST 2025
//--------------------------------------------------------------------------
...
module memlibc_memory_bist_assembly_rtl_tessent_mbist_c1_controller_assembly(LV_TM, 
  ...
  output [35:0] m1_inst_O;
  output BIST_ON, BIST_DONE, BIST_GO, so;

  wire [35:0] m1_interface_instance_I;
  wire [9:0] m1_interface_instance_A;
  wire [4:0] BIST_COL_ADD, BIST_ROW_ADD;
  ...
  memlibc_memory_bist_assembly_rtl_tessent_mbist_c1_interface_m1 m1_interface_instance(
      .WEB_IN(m1_inst_WEB), .CSB_IN(m1_inst_CSB), .A_IN(m1_inst_A[9:0]), .I_IN(m1_inst_I[35:0]), 
