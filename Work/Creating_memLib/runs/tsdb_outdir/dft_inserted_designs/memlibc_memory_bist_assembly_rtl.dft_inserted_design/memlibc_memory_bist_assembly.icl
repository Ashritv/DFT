...
//          Version: 2022.4
//       Created on: Mon Apr 28 10:59:04 IST 2025
//-------------------------------------------------
...
Module SPRAM_1024x36 {
   // ICL module read from source on or near line 17 of file '/home/01fe21bec241/DFT/Work/Creating_memLib/runs/tsdb_outdir/instruments/memlibc_memory_bist_assembly_rtl_mbist.instrument/SPRAM_1024x36.icl'
   DataInPort A[9:0] {
...
Module memlibc_memory_bist_assembly_rtl_tessent_mbist_c1_interface_m1 {
   // ICL module read from source on or near line 25 of file '/home/01fe21bec241/DFT/Work/Creating_memLib/runs/tsdb_outdir/instruments/memlibc_memory_bist_assembly_rtl_mbist.instrument/memlibc_memory_bist_assembly_rtl_tessent_mbist_c1_interface_m1.icl'
   ClockPort BIST_CLK;
...
Module memlibc_memory_bist_assembly_rtl_tessent_mbist_c1_controller {
   // ICL module read from source on or near line 26 of file '/home/01fe21bec241/DFT/Work/Creating_memLib/runs/tsdb_outdir/instruments/memlibc_memory_bist_assembly_rtl_mbist.instrument/memlibc_memory_bist_assembly_rtl_tessent_mbist_c1_controller.icl'
   ClockPort BIST_CLK;
   ...
   Alias A_ADD_REG_Y[4:0] = A_ADD_REG_Y_HW[4:0] {
   }
   Alias A_ADD_REG_X[4:0] = A_ADD_REG_X_HW[4:0] {
   }
   Alias B_ADD_REG_Y[4:0] = B_ADD_REG_Y_HW[4:0] {
   }
   Alias B_ADD_REG_X[4:0] = B_ADD_REG_X_HW[4:0] {
   }
   ...
   ScanRegister A_ADD_REG_Y_HW[0:4] {
      ScanInSource INST_POINTER_REG_HW[3];
   }
   ScanRegister A_ADD_REG_X_HW[0:4] {
      ScanInSource A_ADD_REG_Y_HW[4];
   }
   ScanRegister B_ADD_REG_Y_HW[0:4] {
      ScanInSource A_ADD_REG_X_HW[4];
   }
   ScanRegister B_ADD_REG_X_HW[0:4] {
      ScanInSource B_ADD_REG_Y_HW[4];
   }
   ScanRegister JCNT_HW[0:2] {
      ScanInSource B_ADD_REG_X_HW[4];
   }
...
Module memlibc_memory_bist_assembly_rtl_tessent_mbist_bap {
   // ICL module read from source on or near line 17 of file '/home/01fe21bec241/DFT/Work/Creating_memLib/runs/tsdb_outdir/instruments/memlibc_memory_bist_assembly_rtl_mbist.instrument/memlibc_memory_bist_assembly_rtl_tessent_mbist_bap.icl'
   ResetPort reset {
      ActivePolarity 0;
   }
...
Module memlibc_memory_bist_assembly_rtl_tessent_sib_2 {
   // ICL module read from source on or near line 17 of file '/home/01fe21bec241/DFT/Work/Creating_memLib/runs/tsdb_outdir/instruments/memlibc_memory_bist_assembly_rtl_ijtag.instrument/memlibc_memory_bist_assembly_rtl_tessent_sib_2.icl'
   ResetPort ijtag_reset {
      ActivePolarity 0;
   }
   SelectPort ijtag_sel;
...
Module memlibc_memory_bist_assembly_rtl_tessent_sib_1 {
   // ICL module read from source on or near line 17 of file '/home/01fe21bec241/DFT/Work/Creating_memLib/runs/tsdb_outdir/instruments/memlibc_memory_bist_assembly_rtl_ijtag.instrument/memlibc_memory_bist_assembly_rtl_tessent_sib_1.icl'
   ResetPort ijtag_reset {
      ActivePolarity 0;
   }
   SelectPort ijtag_sel;
