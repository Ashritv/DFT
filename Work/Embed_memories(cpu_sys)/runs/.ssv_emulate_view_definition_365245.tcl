...
create_library_set -name default_emulate_libset_max -timing [list ../lib/slow.lib]
create_library_set -name default_emulate_libset_min -timing [list ../lib/slow.lib]
